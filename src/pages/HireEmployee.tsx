...
const employees: Employee[] = [
  {
    ...
    description: 'Caucasian female with curly brown hair. Builds and nurtures online communities.',
    image: 'https://api.dicebear.com/7.x/adventurer/svg?seed=Kierra&hair=curly&hairColor=brown&skinColor=light',
    skills: ['Community Building', 'Engagement', 'Event Planning', 'Social Listening', 'Moderation'],
    hourlyRate: 19,
    rating: 4.9,
    tasksCompleted: 8800,
    responseTime: '< 2 min',
  ...
  },
  {
    ...
    description: 'Caucasian female with long brown hair. Grows brand presence and engagement on social platforms.',
    image: 'https://api.dicebear.com/7.x/adventurer/svg?seed=Kahlynn&hair=long&hairColor=brown&skinColor=light',
    skills: ['Social Media', 'Brand Growth', 'Influencer Marketing', 'Content Creation', 'Engagement'],
    hourlyRate: 20,
    rating: 4.8,
    tasksCompleted: 9100,
    responseTime: '< 1 min',
